...
// document.addEventListener("mousemove", function() {apiCallOnScroll("./digitalbanking.html", "load-digibank")});
// document.addEventListener("mousemove", function() {apiCallOnScroll("./bannersecurity.html", "load-bannersecurity")});
body.onmousemove = (
    function () {
        var executed = false;
        return function () {
